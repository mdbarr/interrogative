...
function PublicAPI (manager) {
  ...
  manager.api.post('/api/users/register', manager.users.register);
  manager.api.get('/api/users/:id/activate', manager.users.activate);
  manager.api.post('/api/users/forgot', manager.users.forgot);
  manager.api.post('/api/users/:id/reset', manager.users.reset);
